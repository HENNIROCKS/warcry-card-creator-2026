		...
		factions: [
			{
				...
				subfactions: [
					{ label: "Grashrak's Despoilers", svg: cBbGrashraksDespoilers },
				],
			},
			{
				label: 'Blades of Khorne: Bloodbound', svg: cKhorneBloodbound,
				subfactions: [
					{ label: "Garrek's Reavers",    svg: cBbGarrekSReavers },
					{ label: 'Gorechosen of Dromm', svg: null },
					{ label: "Kamandora's Blades",  svg: null },
			...
			{
				label: 'Darkoath', svg: null,
				subfactions: [
					{ label: "Brand's Oathbound", svg: null },
				],
			},
			{ label: 'Darkoath Savagers',                 svg: cDarkoathSavagers,   subfactions: [] },
			{
				...
				subfactions: [
					{ label: 'Eyes of the Nine', svg: cBbEyesOfTheNine },
				],
			},
			{
				label: 'Disciples of Tzeentch: Daemons', svg: cTzeentchDaemons,
				subfactions: [
					{ label: "Ephilim's Pandaemonium", svg: null },
				],
			},
			{
				label: 'Hedonites of Slaanesh: Daemons', svg: cSlaaneshDaemons,
				subfactions: [
					{ label: 'Thricefold Discord', svg: cBbThricefoldDiscord },
				],
			},
			{
				label: 'Hedonites of Slaanesh: Sybarites', svg: cSlaaneshSybarites,
				subfactions: [
					{ label: 'The Dread Pageant', svg: cBbTheDreadPageant },
				],
			},
			{
				label: 'Helsmiths of Hashut', svg: null,
				subfactions: [
					{ label: 'Blood of the Bull', svg: null },
				],
			},
			{ label: 'Iron Golem',                        svg: cIronGolems,         subfactions: [] },
			{
				...
				subfactions: [
					{ label: "Grandfather's Gardeners", svg: null },
				],
			},
			{
			...
			{ label: 'Scions of the Flame',               svg: cScionsOfTheFlame,   subfactions: [] },
			{
				...
				subfactions: [
					{ label: "Skabbik's Plaguepack",    svg: cBbSkabbiksPlaguepack },
					{ label: "Skittershank's Clawpack", svg: cBbSkittershanksClawpack },
					{ label: "Spiteclaw's Swarm",       svg: cBbSpiteclawsSwarm },
					{ label: "Zikkit's Tunnelpack",     svg: null },
				],
			},
			{
				label: 'Slaves to Darkness', svg: cSlavesToDarkness,
				subfactions: [
					{ label: 'Gnarlspirit Pack',  svg: cBbGnarlspiritPack },
					{ label: 'Godsworn Hunt',     svg: cBbGodswornHunt },
...

	{
		...
		factions: [
			{ label: 'Askurgan Trueblades',           svg: dAskurganTrueblades,  subfactions: [] },
			{
				...
				subfactions: [
					{ label: 'Skinnerkin',    svg: dBbSkinnerkin },
			...
			{ label: 'Monsters of Death',             svg: mMonstersOfDeath,    subfactions: [] },
			{
				...
				subfactions: [
					{ label: "The Headman's Curse",       svg: dBbHeadmansCurse },
			...
			{ label: 'Pyregheists',                   svg: null,                subfactions: [] },
			{ label: 'Royal Beastflayers',            svg: dRoyalBeastflayers,  subfactions: [] },
			{
				label: 'Soulblight Gravelords', svg: dSoulblightGravelords,
				subfactions: [
					{ label: 'Sons of Velmorn',               svg: dBbSonsOfVelmorn },
					{ label: 'The Blades of the Hollow King', svg: null },
			...
			{ label: 'Teratic Cohort',                svg: null,                subfactions: [] },
		],
	},
		...
		factions: [
			{
				...
				subfactions: [
					{ label: "Hedkrakka's Madmob", svg: desBbHedkrakkasMadmob },
				],
			},
			{
				label: 'Gloomspite Gitz', svg: desGloomspiteGitz,
				subfactions: [
					{ label: "Borgit's Beastgrabbaz", svg: null },
					{ label: "Grinkrak's Looncourt",  svg: desBbGrinkraksLooncourt },
					{ label: "Mollog's Mob",          svg: desBbMollogsMob },
					{ label: "Rippa's Snarlfangs",    svg: desBbRippasSnarlfangs },
					{ label: "Zarbag's Gitz",         svg: desBbZarbagsGitz },
				],
			},
			{ label: 'Gobbapalooza',                  svg: null,               subfactions: [] },
			{ label: 'Gorger Mawpack',                svg: desGorgerMawpack,   subfactions: [] },
			{
				label: 'Ironjawz', svg: desIronjawz,
				subfactions: [
					{ label: "Ironskull's Boyz", svg: desBbIronskullsBoyz },
					{ label: "Morgok's Krushas", svg: desBbMorgoksKrushas },
				],
			},
			{
				label: 'Kruleboyz', svg: desKruleboyz,
				subfactions: [
					{ label: "Da Kunnin' Krew",    svg: desBbDaKunninKrew },
			...
			{ label: 'Monsters of Destruction',       svg: mMonstersOfDest,      subfactions: [] },
			{
				...
				subfactions: [
					{ label: "Blackpowder's Buccaneers", svg: desBbBlackpowdersBuccaneers },
...

	{
		...
		factions: [
			...
			},
			{
				...
				subfactions: [
					{ label: "Gryselle's Arenai",       svg: oBbGrysellesArenai },
					{ label: "Morgwaeth's Blade-coven", svg: oBbMorgwaethsBladecoven },
					{ label: 'The Knives of the Crone', svg: null },
			...
			{ label: 'Hunters of Huanchi',                           svg: oHuntersOfHuanchi,           subfactions: [] },
			{
				...
				subfactions: [
					{ label: "Cyreni's Razors",     svg: oBbCyrenisRazors },
			...
			{ label: 'Khainite Shadowstalkers',                      svg: oKhainiteShadowstalkers,     subfactions: [] },
			{
				...
				subfactions: [
					{ label: "Thundrik's Profiteers", svg: oBbThundriksProfileers },
				],
			},
			{
			...
			{ label: 'Order of Azyr',                                svg: oOrderOfAzyr,                subfactions: [] },
			{
				label: 'Seraphon', svg: oSeraphon,
				subfactions: [
					{ label: 'Jaws of Itzl',           svg: null },
			...
			{ label: 'Stormcast Eternals: Ruination Chamber',        svg: null,                        subfactions: [] },
			{
			...
			},
			{
				...
				subfactions: [
					{ label: "Domitan's Stormcoven",   svg: oBbDomitansStormcoven },
					{ label: 'Gladitorium Fighters',   svg: null },
					{ label: "Xandire's Truthseekers", svg: oBbXandiressTruthseekers },
				],
			},
			{
				label: 'Stormcast Eternals: Vanguard Auxiliary Chamber', svg: oStormcastVanguardChamber,
				subfactions: [
					{ label: 'The Emberwatch',  svg: null },
					{ label: 'The Farstriders', svg: oBbTheFarstriders },
				],
			},
			{
				label: 'Stormcast Eternals: Warrior Chamber', svg: oStormcastWarriorChamber,
				subfactions: [
					{ label: "Steelheart's Champions", svg: oBbSteelheartSChampions },
				],
			},
			{
				label: 'Sylvaneth', svg: oSylvaneth,
				subfactions: [
					{ label: 'Heralds of Kurnoth',  svg: null },
					{ label: "Skaeth's Wild Hunt",  svg: oBbSkaethsWildHunt },
					{ label: "Ylthari's Guardians", svg: oBbYlthariGuardians },
				],
			},
			{ label: 'The Blacktalons',                              svg: oTheBlacktalons,             subfactions: [] },
			{ label: 'Twistweald',                                   svg: null,                        subfactions: [] },
			...
			{ label: 'Ydrilan Riverblades',                          svg: null,                        subfactions: [] },
		],
	},
];
...
export function getAllianceSvg(alliance: string): string | null {
	return hierarchy.find(a => a.label === alliance)?.svg ?? null;
}

export function getFactionSvg(alliance: string, faction: string): string | null {
	return hierarchy.find(a => a.label === alliance)
		?.factions.find(f => f.label === faction)?.svg ?? null;
}

export function getSubfactionSvg(alliance: string, faction: string, subfaction: string): string | null {
	return hierarchy.find(a => a.label === alliance)
		?.factions.find(f => f.label === faction)
		?.subfactions.find(s => s.label === subfaction)?.svg ?? null;
}

export function getFactions(alliance: string): FactionEntry[] {
	return hierarchy.find(a => a.label === alliance)?.factions ?? [];
}

export function getSubfactions(alliance: string, faction: string): SubfactionEntry[] {
	return hierarchy.find(a => a.label === alliance)
		?.factions.find(f => f.label === faction)?.subfactions ?? [];
}
