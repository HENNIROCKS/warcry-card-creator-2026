...
<style>
	...
	*, *::before, *::after {
	...
	.is-banderole .runemark-border {
		background: #5a0a14;
	}

	.is-banderole .runemark-badge {
		background: #FAF6F3;
	}

	.is-banderole .runemark-badge :global(svg),
	.is-banderole .runemark-badge :global(svg *) {
		fill: #000;
	}
	...
	.is-printer-friendly.is-banderole .runemark-border {
		background: #000;
	}

	.is-printer-friendly.is-banderole .runemark-badge {
		background: #fff;
	}
